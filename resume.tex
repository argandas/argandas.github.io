...
\job
    ...
    \item{Overseeing diverse projects for a US Automotive infotainment client}
    \item{Leading cross-functional teams, with 30+ members}
    \item{Collaborating closely with recruitment to devise hiring strategies}
    \item{Achieved rapid 30-member team staffing in 6 months}
    \item{Utilizing Tableau for data-driven decision-making}
